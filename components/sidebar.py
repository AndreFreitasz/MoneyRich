...
# ========= Layout ========= #
layout = dbc.Col([
    html.H1("Money Rich", className="text-primary"),
    html.P("By André / Victor / Renato / Rafael", className="text-info"),
    html.Hr(),
        ...
        dbc.ModalBody([
            dbc.Row([
                    dbc.Col([
                        dbc.Label('Descrição: '),
                        dbc.Input(
                            placeholder="Ex: salário, dividendos...", id="txt-receita"),
                    ], width=6),
                    dbc.Col([
                        dbc.Label('Valor: '),
                        dbc.Input(
        ...
        dbc.ModalBody([
            dbc.Row([
                dbc.Col([
                    dbc.Label("Descrição: "),
                    dbc.Input(
                        placeholder="Ex.: gasolina, mercado...", id="txt-despesa"),
                ], width=6),
                dbc.Col([
                    dbc.Label("Valor: "),
